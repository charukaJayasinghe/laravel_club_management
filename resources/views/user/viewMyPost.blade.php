                            ...
                            <div class="col-4 pt-4">
                                <div class="card w-100 userDashBackground myShadow">
                                    ...
                                    <div class="d-flex position-absolute align-items-end justify-content-end  w-100">
                                        <span class=" bg-success p-2 text-white mr-3 mt-3">Approved</span>
                                    </div>
                                    @elseif ($post->approval == "0")
                                    <div class="d-flex position-absolute align-items-end justify-content-end  w-100">
                                        <span class="text-dark bg-warning p-2 text-white mr-3 mt-3">Pending</span>
                                    </div>
                                    @elseif ($post->delete == "1")
                                    <div class="d-flex position-absolute align-items-end justify-content-end  w-100">
                                        <span class=" bg-danger p-2 text-white mr-3 mt-3">Disapproved</span>
                                    </div>
                                    @endif
