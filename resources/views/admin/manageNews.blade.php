...
<div class="dash-content p-3" style="z-index: 20;overflow-x: hidden;">
    <div class="row">
        <div class="col-12 title">
            <span class="text2 h1">Manage News</span>
        </div>
        <div class="col-12">
            <div class="row">
                <div class="col-3">
                ...
                <table class="table">
                    <thead class="back">
                        <tr class="textOther">
                            ...
                            <th class="d-none d-lg-table-cell" scope="col">Admin</th>
                    ...
                    <tbody id="userBody">
                        ...
                        @foreach ($data as $data)
                            <tr class="text2 Trow userRow">
                                ...
                                <td  class="d-none d-lg-table-cell">{{ $data->admin->full_name }}</td>
                                ...
                                <td>
                                    ...
                                    <button style="font-size: 20px"
                                        ...
                                        onclick="showNewsDetails({{ $data->id }});">
                                        <span>View</span> <i class="bi bi-eye-fill "></i>
                                    </button>



                                    <button style="font-size: 20px" onclick="deleteNews({{ $data->id }});"
            ...
            @else
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td colspan="6">
                                <h1 class="fs-1 text-center text2">No News to Manage</h1>
                            <td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="modal-body">
                    <div class="row ">
                        <div class="col-12 py-3 d-flex justify-content-center">
                            <img src="{{ asset('images/noImage.jpg') }}" id='postImg' class="img-thumbnail"
                        ...
                        <div class="col-12 px-lg-4">
                            <div class="row">
                                ...
                                <div class=" py-3  col-12">
                                    <span class="h5 d-block text2">Admin : </span>
                                ...
                                <div class=" py-3  col-12 col-lg-12">
                                    ...
                                    <p id="description" class="text2">Lorem, ipsum dolor sit amet consectetur adipisicing
                                        elit. Modi doloribus optio, amet
